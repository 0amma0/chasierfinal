  ...
  <div class="pt-16 pb-80 sm:pt-24 sm:pb-40 lg:pt-40 lg:pb-48">
    <div class="relative mx-auto max-w-7xl px-4 sm:static sm:px-6 lg:px-8">
      <div class="sm:max-w-lg">
        <h1 class="text-4xl font-bold tracking-tight text-gray-900 sm:text-6xl">PT Sinar Nusantara</h1>
        <p class="mt-4 text-xl text-gray-500">Melengkapi kebutuhan harian, membawa cahaya kebahagiaan untuk keluarga. PT Sinar Nusantara, rumah belanja kepercayaan Anda</p>
      </div>
      <div>
        <div class="mt-10">
          ...
          <a href="{{ route('login') }}" class="inline-block rounded-md border border-transparent bg-indigo-600 px-8 py-3 text-center font-medium text-white hover:bg-indigo-700">Masuk Aplikasi</a>
        </div>
      </div>
    </div>
  </div>
