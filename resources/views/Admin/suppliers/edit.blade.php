  ...
  <form method="POST" action="{{ route('admin.suppliers.update', $supplier) }}">
    ...
    <div class="space-y-12">
      <div class="border-b border-gray-900/10 pb-10">
        <h2 class="text-lg font-semibold text-gray-900">Perbarui Data Supplier</h2>
        <p class="mt-1 text-sm text-gray-600">Ubah rincian informasi supplier/distributor <strong>{{ $supplier->name }}</strong>.</p>
          ...
          <div class="col-span-full">
            ...
            <div class="mt-2">
              <textarea id="address" 
                        ...
                        class="block w-full rounded-md bg-white px-3 py-2 text-base text-gray-900 border border-gray-300 placeholder:text-gray-400 focus:outline-2 focus:-outline-offset-2 focus:outline-indigo-600 sm:text-sm/6">{{ old('address', $supplier->address) }}</textarea>
            </div>
            <p class="mt-2 text-xs text-gray-500">Detail alamat digunakan untuk pengiriman barang dan penagihan utang.</p>
          </div>
